...
#SBATCH --nodelist=bnode[0202-0207,0211,0216]
#SBATCH --ntasks=8
...
mpirun -n 8 --map-by node:PE=16 python main.py \
--seed 0 \
--dataset CCN \
...
--out_data_file mp_train_n8_c16_b1_prednet_defaults_ccn.json \
--checkpoint_path ../model_weights/mp_train_n8_c16_b1_prednet_defaults_ccn.pt \
