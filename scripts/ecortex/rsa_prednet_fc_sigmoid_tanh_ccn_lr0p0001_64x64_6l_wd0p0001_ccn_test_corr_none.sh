...
--bias True \
--FC True \
--load_weights_from ../model_weights/train_prednet_fc_sigmoid_tanh_ccn_lr0p0001_64x64_6l_wd0p0001.pt \
--results_dir ../results/rsa/ \
--out_data_file prednet_fc_sigmoid_tanh_ccn_lr0p0001_64x64_6l_wd0p0001.hkl
