...
--out_data_file train_prednet_fc_sigmoid_tanh_d0p1_ccn_lr0p0001_64x64_7l.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_d0p1_ccn_lr0p0001_64x64_7l.pt \
--checkpoint_every 2 \
--record_E True \
