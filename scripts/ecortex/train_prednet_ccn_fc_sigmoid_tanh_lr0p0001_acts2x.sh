...
--out_data_file train_prednet_fc_sigmoid_tanh_acts2x_ccn_lr0p0001.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_acts2x_ccn_lr0p0001.pt \
--checkpoint_every 2 \
