...
echo "Learning rate is 0.1, no steps in scheduler"
...
--out_data_file train_prednet_fc_sigmoid_tanh_ccn_lr0p1.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_ccn_lr0p1.pt \
--checkpoint_every 2 \
