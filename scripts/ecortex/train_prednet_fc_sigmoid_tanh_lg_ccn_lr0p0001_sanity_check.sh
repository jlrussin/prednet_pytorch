...
--out_data_file train_prednet_fc_sigmoid_tanh_lg_ccn_lr0p0001_sanity_check.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_lg_ccn_lr0p0001_sanity_check.pt \
--checkpoint_every 2 \
--record_E True \
