...
--out_data_file train_prednet_fc_sigmoid_tanh_ccn_lr0p0001_64x64.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_ccn_lr0p0001_64x64.pt \
--checkpoint_every 2 \
--record_E True \
...
--lr_steps 0 \
--results_dir ../results/train_results \
--out_data_file train_prednet_fc_sigmoid_tanh_ccn_lr0p0001_128x128_6l.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_ccn_lr0p0001_128x128_6l.pt \
--checkpoint_every 2 \
--record_E True \
--record_loss_every 200
