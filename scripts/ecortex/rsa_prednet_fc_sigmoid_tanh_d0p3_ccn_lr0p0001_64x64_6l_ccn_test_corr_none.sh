...
--FC True \
--dropout_p 0.3 \
--load_weights_from ../model_weights/train_prednet_fc_sigmoid_tanh_d0p3_ccn_lr0p0001_64x64_6l.pt \
--results_dir ../results/rsa/ \
--out_data_file prednet_fc_sigmoid_tanh_d0p3_ccn_lr0p0001_64x64_6l.hkl
