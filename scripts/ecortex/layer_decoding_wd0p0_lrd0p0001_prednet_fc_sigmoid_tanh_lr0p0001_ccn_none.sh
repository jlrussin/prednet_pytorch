...
--out_data_file wd0p0_lrd0p0001_prednet_fc_sigmoid_tanh_lr0p0001_ccn_none.json \
--checkpoint_path ../model_weights/train_wd0p0_lrd0p0001_prednet_fc_sigmoid_tanh_ccn_lr0p0001 \
--checkpoint_every 2 \
