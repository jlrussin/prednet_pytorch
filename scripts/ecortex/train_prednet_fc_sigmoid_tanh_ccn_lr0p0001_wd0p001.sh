...
--out_data_file train_prednet_fc_sigmoid_tanh_ccn_lr0p0001_wd0p001.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_ccn_lr0p0001_wd0p001.pt \
--checkpoint_every 2 \
--record_E True \
