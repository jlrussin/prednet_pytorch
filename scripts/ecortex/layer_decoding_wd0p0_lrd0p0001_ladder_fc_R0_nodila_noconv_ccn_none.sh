...
--no_R0 False \
--no_skip0 True \
--load_weights_from ../model_weights/train_ladder_fc_R0_nodila_noconv.pt \
--learning_rate 0.0001 \
--results_dir ../results/layer_decoding/ \
--out_data_file wd0p0_lrd0p0001_ladder_fc_R0_nodila_noconv_ccn_none.json \
--checkpoint_path ../model_weights/train_wd0p0_lrd0p0001_ladder_fc_R0_nodila_noconv_ccn \
--checkpoint_every 2 \
