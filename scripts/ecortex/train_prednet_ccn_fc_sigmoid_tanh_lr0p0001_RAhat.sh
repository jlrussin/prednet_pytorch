...
echo "Training PredNet with fc, sigmoid, tanh, RAhat on CCN dataset"
...
--out_data_file train_prednet_fc_sigmoid_tanh_RAhat_ccn_lr0p0001.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_RAhat_ccn_lr0p0001.pt \
--checkpoint_every 2 \
