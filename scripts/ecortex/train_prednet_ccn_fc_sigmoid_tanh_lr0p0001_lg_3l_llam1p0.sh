...
echo "Layer lambdas at 1.0, 3 layers"
...
--out_data_file train_prednet_fc_sigmoid_tanh_lg_3l_ccn_lr0p0001_llam1p0.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_lg_3l_ccn_lr0p0001_llam1p0.pt \
--checkpoint_every 2 \
--record_E True \
