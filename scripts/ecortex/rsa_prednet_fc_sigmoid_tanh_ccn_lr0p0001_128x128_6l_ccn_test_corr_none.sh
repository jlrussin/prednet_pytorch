...
--bias True \
--FC True \
--load_weights_from ../model_weights/train_prednet_fc_sigmoid_tanh_ccn_lr0p0001_128x128_6l.pt \
--results_dir ../results/rsa/ \
--out_data_file prednet_fc_sigmoid_tanh_ccn_lr0p0001_128x128_6l.hkl
