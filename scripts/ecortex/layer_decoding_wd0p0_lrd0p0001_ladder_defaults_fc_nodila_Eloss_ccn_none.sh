...
--out_data_file wd0p0_lrd0p0001_ladder_defaults_fc_nodila_Eloss_ccn_none.json \
--checkpoint_path ../model_weights/train_wd0p0_lrd0p0001_ladder_defaults_fc_nodila_Eloss_ccn \
--checkpoint_every 2 \
