...
--out_data_file train_prednet_fc_sigmoid_tanh_acts_lg_ccn_lr0p0001_llam0p0.json \
--checkpoint_path ../model_weights/train_prednet_fc_sigmoid_tanh_acts_lg_ccn_lr0p0001_llam0p0.pt \
--checkpoint_every 2 \
--record_E True \
