...
--local_grad True \
--forward_conv True \
--load_weights_from ../model_weights/train_stacked_fconv_lg_lr0p0001.pt \
--learning_rate 0.0001 \
--results_dir ../results/layer_decoding/ \
--out_data_file wd0p0_lrd0p0001_stacked_fconv_lg_ccn_none.json \
--checkpoint_path ../model_weights/train_wd0p0_lrd0p0001_stacked_fconv_lg_ccn \
--checkpoint_every 2 \
