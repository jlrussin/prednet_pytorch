...
--no_R0 False \
--no_skip0 True \
--load_weights_from ../model_weights/train_ladder_defaults_fc_R0_nodila_noBN_lg_Eloss.pt \
--learning_rate 0.0001 \
--results_dir ../results/layer_decoding/ \
--out_data_file wd0p0_lrd0p0001_ladder_fc_R0_nodila_noBN_lg_ccn_none.json \
--checkpoint_path ../model_weights/train_wd0p0_lrd0p0001_ladder_fc_R0_nodila_noBN_lg_ccn \
--checkpoint_every 2 \
